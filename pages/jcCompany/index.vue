        ...
        <div class="part-box">
          <div class="search-left fl">
            <section class="px-box">
              ...
              <em class="click-order" data-order="total " data-type="desc" @click="listOrder">综合实力</em>
              ...
              <ul class="company-list" v-if="zxCompanyList.length > 0">
                <li v-for="com in zxCompanyList">
                  <div class="left-img fl">
                    ...
                    <!--<p>咨询人数：<em class="color-red">暂无</em></p>-->
                  </div>
                  <div class="middle-info fl">
                    <router-link class="title" :to="{path: 'jcCompanyInfo/'+ com.id+'/product'}" :title="com.title" target="_blank">{{com.title}}</router-link>
                    <div class="tags">
                      <em class="bg-red">营</em><em class="bg-yellow">金</em><em class="bg-blue">惠</em>
                      <div class="fr">产品：<em class="color-red">{{com.total}}</em>个</div>
                    </div>
                  ...
                  <div class="right-rate fl">
                    ...
                    <div class="right-bottom">好评率：<em class="color-red">{{(com.pingfeng / 5 * 100).toFixed(1) + '%'}}</em></div>
                  </div>
                </li>
              </ul>
          ...
          <div class="search-right fr">
            ...
            <!--<a class="right-content-item" v-for="ad in adPosition" :href="ad.link">-->
            <!--<img :src='ad.img' :alt="ad.alt">-->
            <!--</a>-->
            <a class="right-content-item">
              <img src='~/static/img/ad05.jpg' alt="团队一心，其利断金">
            </a>
            <a class="right-content-item">
              <img src='~/static/img/ad06.jpg' alt="与梦想共舞">
            </a>
          </div>
          <div class="cl"></div>
        </div>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    data () {
      return {
        meta: { tabIndex: 2, hideHeader: true, hideFooter: true },
...
<style scoped>
  .main-searchList-zx .part-search{
    width: 100%;
    height: 230px;
    background: url(/static/img/banner2.jpg) no-repeat;
