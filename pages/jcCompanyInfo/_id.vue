  ...
  <div class="">
    ...
    <div class="main">
      ...
      <div class="part part-tab">
        <div class="part-box">
          <router-link :to="{path: '/jcCompanyinfo/' + com.id + '/product'}" :class="{on: $route.path.indexOf('product') >= 0 }">产品分类</router-link>
          <router-link :to="{path: '/jcCompanyinfo/' + com.id + '/project'}" :class="{on: $route.path.indexOf('project') >= 0 }">相关项目</router-link>
          <router-link :to="{path: '/jcCompanyinfo/' + com.id + '/comment'}" :class="{on: $route.path.indexOf('comment') >= 0 }">业主评价</router-link>
          <router-link :to="{path: '/jcCompanyinfo/' + com.id + '/introduction'}" :class="{on: $route.path.indexOf('introduction') >= 0 }">公司简介</router-link>
        </div>
      </div>
