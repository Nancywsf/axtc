...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    asyncData (context) {
      function getHotWord () {
        return axios.get(context.store.state.HOST + 'http://zx.axfc.cn/zxpc/company/getHotKeyword?type=1')
      }
      function getCompanyList () {
        ...
        return axios.post(context.store.state.HOST + 'http://zx.axfc.cn/zxpc/company/getZxCompanyList', data)
      }
      return axios.all([
        getHotWord(),
        getCompanyList()
